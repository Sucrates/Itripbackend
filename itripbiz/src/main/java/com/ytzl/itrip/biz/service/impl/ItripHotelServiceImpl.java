...
public class ItripHotelServiceImpl implements ItripHotelService {
    ...
    @Override
    public List<ItripLabelDic> queryItripHotelFeatureByHotelId(int hotelId) {
        return itripHotelMapper.queryItripHotelFeatureByHotelId(hotelId);
    }

    @Override
    public List<ItripAreaDic> queryItripHotelAreaByHotelId(int hotelId) {
        return itripHotelMapper.queryItripHotelAreaByHotelId(hotelId);
    }
}
